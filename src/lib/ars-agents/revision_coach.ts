// Auto-generated from _revision_coach_agent.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: Revision roadmap + revised-draft agent from reviewer comments (shared with pipeline P13)

export const REVISION_COACH_PROMPT = `---
