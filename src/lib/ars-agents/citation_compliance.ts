// Auto-generated from _citation_compliance_agent.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: Verifies and auto-corrects citation formatting; achieves zero orphan citations

export const CITATION_COMPLIANCE_PROMPT = `---
