// Auto-generated from _rq_formulator.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: deep-research RQ formulator (FINER research-question brief; P9 Stage 1)

export const RQ_FORMULATOR_PROMPT = `---
