// Auto-generated from _literature_searcher.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: deep-research literature searcher / bibliography builder (P9 Stage 1)

export const LITERATURE_SEARCHER_PROMPT = `---
