// Auto-generated from _methodology_selector.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: deep-research methodology blueprint selector (P9 Stage 1)

export const METHODOLOGY_SELECTOR_PROMPT = `---
