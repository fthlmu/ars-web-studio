// Auto-generated from _deep_research_skill.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: deep-research family SKILL.md — routes the deep-research modes via a MODE directive (QT6/QT7)

export const DEEP_RESEARCH_SKILL_PROMPT = `---
name: deep-research
