// Auto-generated from _draft_writer_agent.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: Writes complete paper sections following TEEL structure with citation density enforcement

export const DRAFT_WRITER_PROMPT = `---
