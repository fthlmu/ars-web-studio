// Auto-generated from _reviewer_skill.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: academic-paper-reviewer family SKILL.md — routes the reviewer modes via a MODE directive (QT4/QT7)

export const REVIEWER_SKILL_PROMPT = `---
