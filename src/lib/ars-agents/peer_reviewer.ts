// Auto-generated from _peer_reviewer_agent.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: 5-dimension peer-review scoring agent (QT4; shared with pipeline P11)

export const PEER_REVIEWER_PROMPT = `---
