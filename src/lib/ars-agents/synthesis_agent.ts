// Auto-generated from _synthesis_agent.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: Cross-source synthesis / contradiction resolution (bundled for QT6; shared with pipeline P9)
