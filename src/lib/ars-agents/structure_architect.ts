// Auto-generated from _structure_architect_agent.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: Designs the paper section architecture and detailed outline before drafting begins

export const STRUCTURE_ARCHITECT_PROMPT = `---
