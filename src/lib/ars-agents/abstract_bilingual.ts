// Auto-generated from _abstract_bilingual_agent.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: Writes bilingual abstract (English + secondary language) with 5-component structure

export const ABSTRACT_BILINGUAL_PROMPT = `---
