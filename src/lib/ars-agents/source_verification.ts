// Auto-generated from _source_verification_agent.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: Verifies factual claims against sources (QT6 fact-check; shared with pipeline P9)
