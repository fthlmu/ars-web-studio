// Auto-generated from _academic_paper_skill.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: academic-paper family SKILL.md — routes the 10 academic-paper modes via a MODE directive

export const ACADEMIC_PAPER_SKILL_PROMPT = `---
name: academic-paper
