// Auto-generated from _integrity_verification_agent.md — do not edit manually.
// ARS agent system prompt bundled as a local constant (no runtime network fetch).
// Description: 7-mode (M1-M7) academic integrity verification gatekeeper (pipeline Stage 2.5 + 4.5; P10/P15)

export const INTEGRITY_VERIFICATION_PROMPT = `---
