...
export const TOOL_MODES: ToolMode[] = [
  ...
  },
  {
    ...
    delivery: '1-shot', status: 'ready', deliversInPhase: 'QT6', approximation: true,
    promptModeKey: 'quick',
  },
  {
    ...
    intake: ['topic'], promptSource: { kind: 'skill-dir', skill: 'deep-research' },
    delivery: 'chain', status: 'ready', deliversInPhase: 'QT6', approximation: true,
  ...
  },
  {
    ...
    intake: ['topic'], promptSource: { kind: 'skill-dir', skill: 'deep-research' },
    delivery: 'interactive', status: 'ready', deliversInPhase: 'QT7', approximation: true,
  ...
  },
  {
    ...
    delivery: '1-shot', status: 'ready', deliversInPhase: 'QT6',
  },
  {
  ...
  },
  {
    ...
    delivery: 'interactive', status: 'ready', deliversInPhase: 'QT7',
    promptModeKey: 'plan',
  },
  {
  ...
  },
  {
    ...
    delivery: '1-shot', status: 'ready', deliversInPhase: 'QT5',
  ...
  },
  {
    ...
    intake: ['topic'], promptSource: { kind: 'skill-dir', skill: 'academic-paper' },
    delivery: 'chain', status: 'ready', deliversInPhase: 'QT3',
    promptModeKey: 'lit-review',
  },
  {
  ...
  },
  {
    ...
    intake: ['byo-paper'], promptSource: { kind: 'skill-dir', skill: 'academic-paper' },
    delivery: '1-shot', status: 'ready', deliversInPhase: 'QT3',
    promptModeKey: 'disclosure',
    directive: 'Generate a venue-specific AI-usage disclosure statement for the paper below.',
    optionFields: [
  ...
  // ── Academic Paper Reviewer (6) — all need a pasted paper ───────────────────
  {
    ...
    delivery: 'chain', status: 'ready', deliversInPhase: 'QT4',
  },
  {
    ...
    delivery: '1-shot', status: 'ready', deliversInPhase: 'QT4',
    promptModeKey: 'quick',
  },
  {
